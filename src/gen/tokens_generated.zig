...
// Single-byte tokens: 236 entries
const single_byte_tokens = [_][]const u8{
    "",
    "xmlstreamstart",
    "xmlstreamend",
    "s.whatsapp.net",
...
// Double-byte tokens: 4 pages of 256 entries each
const double_byte_tokens = [_][256][]const u8{
    // Page 0
    .{
        "read-self",
        "active",
